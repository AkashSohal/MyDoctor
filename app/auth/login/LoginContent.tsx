    ...
    <div className="min-h-screen bg-secondary-50 flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-secondary-500 mt-2">Sign in to your {role} account</p>
        </div>
          ...
          <CardContent className="space-y-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href={`/auth/forgot-password?role=${role}`} className="text-sm text-primary-600 hover:text-primary-700">
                  Forgot password?
                </Link>
              </div>
            ...
            <p className="text-center text-sm text-secondary-500">
              ...
              <Link href={`/auth/register?role=${role}`} className="text-primary-600 hover:text-primary-700 font-medium">
                Sign up
              </Link>
            </p>
          </CardContent>
